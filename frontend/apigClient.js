...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://o87u6s0j4b.execute-api.us-east-1.amazonaws.com/SmartPhotoAlbum';
    ...
    apigClient.uploadPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['Content-Type', 'photos', 'x-amz-meta-customLabels'], ['body']);
        ...
        var uploadPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'photos', 'x-amz-meta-customLabels']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
